...
def favicon():
    return redirect('https://cdn.jsdelivr.net/gh/from-another-universe/trendinganime@main/static/img/favicon.ico')
...
def home():
    ...
    update_views('home-trendinganime')
    return html
...
def search_anime():
    ...
    update_views('search-trendinganime')
    return html
